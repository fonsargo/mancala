...
public class BoardModelTest {
    ...
    void shouldMakeSimpleMove() {
        ...
        BoardModel expected = TestUtils.createBoardModel(
                List.of(6, 0, 7, 7, 7, 7),
                1,
                List.of(7, 6, 6, 6, 6, 6),
                0,
    ...
    void shouldMakeSimpleMoveFromSecondPlayer() {
        BoardModel board = TestUtils.createBoardModel(
    ...
    @Test
    void shouldThrowExceptionIfPitIsEmpty() {
        BoardModel board = TestUtils.createBoardModel(
                Lists.newArrayList(3, 4, 5, 0, 7, 5),
                8,
                Lists.newArrayList(0, 0, 0, 0, 0, 5),
        ...
        assertThrows(IllegalArgumentException.class, () ->  board.makeMove(3));
    }

    @Test
    void shouldThrowExceptionIfPitIndexOutOfBound() {
        BoardModel board = TestUtils.createBoardModel(
                Lists.newArrayList(3, 4, 5, 0, 7, 5),
                8,
                Lists.newArrayList(0, 0, 0, 0, 0, 5),
        ...
        assertThrows(IllegalArgumentException.class, () ->  board.makeMove(30));
    }
}
